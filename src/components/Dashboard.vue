	...
	<div class="grid">
		...
		<div class="col-12 xl:col-6" >
			<div class="card" style="max-height: 100%; min-height: 100%; ">
				<h5>Recent Sales</h5>
				<DataTable class="p-datatable-sm" :value="products" :rows="4" :paginator="true" responsiveLayout="scroll" :rowHover="true" 
								v-model:filters="filters1" filterDisplay="menu" :loading="loading1" :filters="filters1" dataKey="id"
								:globalFilterFields="['name','price']" >
					<template #header>
						<div class="flex justify-content-between flex-column sm:flex-row">
							<Button type="button" icon="pi pi-filter-slash" class="p-button-outlined my-auto p-button-sm" @click="clearFilter1()" v-tooltip="'Clear'"/>
							<span class="p-input-icon-left mb-2">
								<i class="pi pi-search" />
								<InputText class="p-inputtext-sm mt-1" v-model="filters1['global'].value" placeholder="Keyword Search" style="width: 100%;"/>
							</span>
						</div>
					</template>
