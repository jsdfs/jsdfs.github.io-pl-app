    ...
    <div class="card">
        ...
        <template v-if="dataList != null">
            <DataTable :value="dataList" dataKey="seqId" responsiveLayout="scroll" selectionMode="single"
                @row-click="rowClick"
            >
                <Column field="exclusionCode" header="Exclusion Code" :sortable="true" style="width:30%;">
                </Column>
                <Column field="divisionDesc" header="Division" :sortable="true" style="width:20%;">
                </Column>
                <Column field="effectiveDateFrom" header="Effective Date (From)" :sortable="true" style="width:25%;">
                    <template #body="slotProps">
                        {{ dateFormat(slotProps.data.effectiveDateFrom)}}
                    </template>
                </Column>
                <Column field="effectiveDateTo" header="Effective Date (To)" :sortable="true" style="width:25%;">
                    <template #body="slotProps">
...
export default {
    ...
    setup (props) {
        ...
        const rowClick = (e) => { 
            store.dispatch('exclusion/set', e.data);
            router.push("/exclusioncodedet");
        }
