    ...
    >
        <template #header>
            <div class="flex justify-content-between">
                ...
                <div>
                    <ExistingSubstandardProposalAddModal
                        :data="inputForm"
        ...
        <Column field="proposalStatus" header="Proposal Status"></Column>
...
import ExistingSubstandardProposalAddModal from '@/components/nb/maintenance/ExistingSubstandardProposalAddModal';

export default {
    name: 'ExistingSubstandardProposalDataTable',
    components: {
        ExistingSubstandardProposalAddModal
    },
    props: {
    ...
    setup(props, { emit }) {
        ...
        const existingSubstandardLs = ref({});
        const searchForm = toRef(props, 'inputForm');

        onBeforeUpdate(() => {
            masterDataService.getDetailByHeaderCode('JETEXCPROPSTATTBL').then(res => {
                existingSubstandardLs.value = res.data;
            });
        })
