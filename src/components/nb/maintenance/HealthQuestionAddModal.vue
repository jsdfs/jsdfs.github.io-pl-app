<template>
 <Button icon="pi pi-plus" style="background-color:#000080;" class="p-button-info mr-2 mb-2" @click="openModal" />
    ...
    <Dialog header="Add Health Question" v-model:visible="displayModal" :style="{width: '50vw'}" :modal="true">
        <div class="grid">
            <div class="col-12">
                <div class="card">
                    <div class="p-fluid formgrid grid">  
                        <div class="field col-12 md:col-6">
                            ...
                            <InputText id="tableNo" type="text"  v-model="inputForm.tableNo"/>
                        </div>
...
export default {
    ...
    setup() {
        ...
        const add = () =>{
            //store.dispatch('healthquestion/add', inputForm.value);
