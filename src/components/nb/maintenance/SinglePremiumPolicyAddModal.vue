<template>
    ...
    <Dialog header="Add Single Premium Policy" v-model:visible="displayModal" :style="{width: '50vw'}" :modal="true">
        <div class="grid">
            <div class="col-12">
                <div class="card">
                    <div class="p-fluid formgrid grid">  
                        ...
                        <div class="field col-12 md:col-6">
                            <label for="totalSinglePremium">Total Single Premium</label>
                            <InputText id="totalSinglePremium" type="text"  v-model="inputForm.totalSinglePremium" />
                        </div>
                        <div class="field col-12 md:col-6">
                            <label for="productCode">Product Code</label>
                            <InputText id="productCode" type="text"  v-model="inputForm.productCode" />
                        </div>
                        <!-- <KeyTable 
...
export default {
    ...
    setup() {
        ...
        const add = () =>{
            //store.dispatch('singlepremiumpolicy/add', inputForm.value);
