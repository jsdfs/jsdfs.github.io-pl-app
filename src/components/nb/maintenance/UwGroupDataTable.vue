<template>
                ...
                <template #header>
                    <div class="flex justify-content-between">
                        <span class="p-input-icon-left">
                            ...
                            <InputText v-model="searchForm.uwGroup" placeholder="Keyword Search" @input="changed()" />
    ...
    <Dialog v-model:visible="uwGroupDetailModal" :breakpoints="{'960px': '75vw', '640px': '100vw'}" :style="{width: '40vw'}" :modal="true" class="p-fluid" @update:visible="closeModal">
        <template #header>
...
export default {
    name: 'UwGroupDataTable',
    components: {
        UwGroupAddModal
    },
    props: {
        tableData: Object,
        uwGroupFullref: Object,
        tableType: Object,
        tableCode: Object,
        inputForm: Object,
    },
